...
/**
 * Title:CsGylInfoPage<br/>
 * Description:(供应链公司信息Page分页类)<br/>
 * Copyright: Copyright © 2016<br/>
 * Company: 深圳市擎天柱信息技术有限公司<br/>
 * @author 甘佳-jackgrays@matrix.com
 * @version v1.0 2016-04-20
 */
public class CsGylInfoPage extends Pager<CsGylInfo,Long> implements Serializable {

    /**(序列化UID)*/
    private static final long serialVersionUID = 3255160949952236471L;
    /**(供应链公司ID)*/
    private Long dmId;
    /**(供应链公司编号(有业务规则))*/
