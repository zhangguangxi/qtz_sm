 ...
 */
public interface SearchService extends BaseService<com.qtz.sm.search.vo.SearchList,Long> {
	/**
	 * 按照搜索人删除搜索记录
	 * @param searchUser
	 ...
	 * @throws ServiceException
	 */
	Pager<Search, Long> searchShopList(SearchPage page) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	Pager<Search, Long> searchShopGoodsList(SearchPage page) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	Pager<Search, Long> indexQueryList(SearchPage page) throws ServiceException;
