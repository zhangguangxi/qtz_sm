...
public class WtWalletPage extends Pager<com.qtz.sm.wallet.vo.WtWallet,java.lang.Long> implements java.io.Serializable{
	...
	public String toString() {	    return "[" + "dmId:" + getDmId() +"," + "ownerType:" + getOwnerType() +"," + "ownerId:" + getOwnerId() +"," + "ownerName:" + getOwnerName() +"," + "itemId:" + getItemId() +"," + "itemName:" + getItemName() +"," + "itemAmount:" + getItemAmount() +"," + "payerType:" + getPayerType() +"," + "payerId:" + getPayerId() +"," + "createTime:" + getCreateTime()+ "createBy:" + getCreateBy()+ "updateTime:" + getUpdateTime() +"," + "updateBy:" + getUpdateBy() +"]";	}
}