...
/**
 * <p>Title:GdGoodsPage</p>
 * <p>Description:商品分页类</p>
 * <p>Copyright: Copyright (c) 2016</p>
 * <p>Company: 深圳擎天柱信息技术有限公司</p>
 * @author 欧江波 - 928482427@qq.com
 * @version v1.0 2016-05-26
 */
public class GdGoodsPage extends Pager<com.qtz.sm.goods.vo.GdGoods,java.lang.Long> implements java.io.Serializable{

	/**类的版本号*/
	private static final long serialVersionUID = 1678897741793281L;
	...
	public String toString() {
	    return "[" + "dmId:" + getDmId() +"," + "supplierId:" + getSupplierId() +"," + "brandsId:" + getBrandsId() +"," + "goodsTypeId:" + getGoodsTypeId() +"," + "code:" + getCode() +"," + "name:" + getName() +"," + "remark:" + getRemark() +"," + "status:" + getStatus() +"," + "createBy:" + getCreateBy() +"," + "createOn:" + getCreateOn() +"," + "updateBy:" + getUpdateBy() +"," + "updateOn:" + getUpdateOn() +"," + "goodsProValMsg:" + getGoodsProValMsg() +"]";
	}
}