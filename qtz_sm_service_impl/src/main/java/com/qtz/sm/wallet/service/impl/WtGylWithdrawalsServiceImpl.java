...
/**
 * <p>Title:WtGylWithdrawalsServiceImpl</p>
 * <p>Description:供应链提现流水服务实现类</p>
 * <p>Copyright: Copyright (c) 2016</p>
  * <p>Company: 深圳擎天柱信息技术有限公司</p>
 * @author 徐运贤 - xuyunxian@126.com
 * @version v1.0 2016-05-11
 */
@Service("wtGylWithdrawalsServiceImpl")
public class WtGylWithdrawalsServiceImpl extends BaseServiceImpl<com.qtz.sm.wallet.vo.WtGylWithdrawals,java.lang.Long> implements WtGylWithdrawalsService  {
	/**初始化日志对象*/
	private static LogTool log = LogTool.getInstance(WtGylWithdrawalsServiceImpl.class);
	/**注入供应链提现流水DAO接口类*/
	@Resource(name="wtGylWithdrawalsDaoImpl")
    private WtGylWithdrawalsDao dao;
	...
	*/
	@Override
	protected BizDao<com.qtz.sm.wallet.vo.WtGylWithdrawals,java.lang.Long> getDao() {
		return dao;
	}
	/** 
	* 【取得】日志对象
	...
	*/
	...
	public void saveApplyWithdrawals(WtGylWithdrawals vo) throws ServiceException {
		try {
			...
			//从配置文件中读取供应链结算周期的设置参数
			String period=BaseProperties.getBaseProperties("gyl.withdrawals.period");
			...
			wVo.setOwnerType(CompanyType.SupplyChain.value());
	...
	public void saveAccepWithdrawals(WtGylWithdrawals vo) throws ServiceException {
		try {
			WtGylWithdrawals withdrawals = dao.findVo(vo.getDmId(), null);
			if (null == withdrawals) {
			...
			//获取收款人已付钱包
			WtWallet wPaid=wtWalletService.getPaidByTissue(wWithdrawals.getPayerId(), CompanyType.CloudStorage.value(), CompanyType.SupplyChain.value(),WalletItemEnum.PAID.getValue());
			//获取收款人未付钱包
			WtWallet uwPaid=wtWalletService.getPaidByTissue(wWithdrawals.getPayerId(), CompanyType.CloudStorage.value(), CompanyType.SupplyChain.value(),WalletItemEnum.UPPAID.getValue());
	 ...
	 * @throws DaoException 
	 */
	public void addWtWithdrawalsOperation(WtGylWithdrawals vo, String createContent) throws DaoException {
