...
/**
 * <p>Title:WtBldWithdrawalsServiceImpl</p>
 * <p>Description:便利店提现流水服务实现类</p>
 * <p>Copyright: Copyright (c) 2016</p>
  * <p>Company: 深圳擎天柱信息技术有限公司</p>
 * @author 徐运贤 - xuyunxian@126.com
 * @version v1.0 2016-05-11
 */
@Service("wtBldWithdrawalsServiceImpl")
public class WtBldWithdrawalsServiceImpl extends BaseServiceImpl<com.qtz.sm.wallet.vo.WtBldWithdrawals,java.lang.Long> implements WtBldWithdrawalsService  {
	/**初始化日志对象*/
	private static LogTool log = LogTool.getInstance(WtBldWithdrawalsServiceImpl.class);
	/**注入便利店提现流水DAO接口类*/
	@Resource(name="wtBldWithdrawalsDaoImpl")
    private WtBldWithdrawalsDao dao;
	...
	*/
	@Override
	protected BizDao<com.qtz.sm.wallet.vo.WtBldWithdrawals,java.lang.Long> getDao() {
		return dao;
	}
	/** 
	* 【取得】日志对象
	...
	*/
	...
	public void saveApplyWithdrawals(WtBldWithdrawals vo) throws ServiceException {
		...
		try {
			...
			//从配置文件中读取便利店结算周期的设置参数
			String period=BaseProperties.getBaseProperties("bld.withdrawals.period");
			...
			wVo.setOwnerType(CompanyType.Store.value());
	...
	public void saveAccepWithdrawals(WtBldWithdrawals vo) throws ServiceException {
		// TODO Auto-generated method stub
		try {
			WtBldWithdrawals withdrawals = dao.findVo(vo.getDmId(), null);
			if (null == withdrawals) {
			...
			//获取收款人已付钱包
			WtWallet wPaid=wtWalletService.getPaidByTissue(wWithdrawals.getPayerId(), CompanyType.StoreManager.value(), CompanyType.Store.value(),WalletItemEnum.PAID.getValue());
			//获取收款人未付钱包
			WtWallet uwPaid=wtWalletService.getPaidByTissue(wWithdrawals.getPayerId(), CompanyType.StoreManager.value(), CompanyType.Store.value(),WalletItemEnum.UPPAID.getValue());
	 ...
	 * @throws DaoException 
	 */
	public void addWtWithdrawalsOperation(WtBldWithdrawals vo, String createContent) throws DaoException {
