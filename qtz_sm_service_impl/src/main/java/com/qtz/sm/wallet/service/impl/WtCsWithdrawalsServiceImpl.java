...
/**
 * <p>Title:WtCsWithdrawalsServiceImpl</p>
 * <p>Description:超市提现流水服务实现类</p>
 * <p>Copyright: Copyright (c) 2016</p>
  * <p>Company: 深圳擎天柱信息技术有限公司</p>
 * @author 徐运贤 - xuyunxian@126.com
 * @version v1.0 2016-05-11
 */
@Service("wtCsWithdrawalsServiceImpl")
public class WtCsWithdrawalsServiceImpl extends BaseServiceImpl<com.qtz.sm.wallet.vo.WtCsWithdrawals,java.lang.Long> implements WtCsWithdrawalsService  {
	/**初始化日志对象*/
	private static LogTool log = LogTool.getInstance(WtCsWithdrawalsServiceImpl.class);
	/**注入超市提现流水DAO接口类*/
	@Resource(name="wtCsWithdrawalsDaoImpl")
    private WtCsWithdrawalsDao dao;
	...
	*/
	@Override
	protected BizDao<com.qtz.sm.wallet.vo.WtCsWithdrawals,java.lang.Long> getDao() {
		return dao;
	}
	/** 
	* 【取得】日志对象
	...
	*/
	...
	public void saveApplyWithdrawals(WtCsWithdrawals vo) throws ServiceException {
		...
		try {
			...
			//从配置文件中读取超市结算周期的设置参数
			String period=BaseProperties.getBaseProperties("cs.withdrawals.period");
			...
			wVo.setOwnerType(CompanyType.SuperMarket.value());
	...
	public void saveAccepWithdrawals(WtCsWithdrawals vo) throws ServiceException {
		// TODO Auto-generated method stub
		try {
			WtCsWithdrawals withdrawals = dao.findVo(vo.getDmId(), null);
			if (null == withdrawals) {
	 ...
	 * @throws DaoException 
	 */
	public void addWtWithdrawalsOperation(WtCsWithdrawals vo, String createContent) throws DaoException {
