...
import com.qtz.sm.wallet.dao.WtYccCsWithdrawalsDao;
...
/**
 * <p>
 * Title:WtYccCsWithdrawalsServiceImpl
 * </p>
 * <p>
 * Description:云仓储向超市提现流水服务实现类
 * </p>
 * <p>
 ...
 */
@Service("wtYccCsWithdrawalsServiceImpl")
public class WtYccCsWithdrawalsServiceImpl extends
		BaseServiceImpl<com.qtz.sm.wallet.vo.WtYccCsWithdrawals, java.lang.Long>implements WtYccCsWithdrawalsService {
	/** 初始化日志对象 */
	private static LogTool log = LogTool.getInstance(WtYccCsWithdrawalsServiceImpl.class);
	/** 注入云仓储向超市提现流水DAO接口类 */
	@Resource(name = "wtYccCsWithdrawalsDaoImpl")
	private WtYccCsWithdrawalsDao dao;
	 ...
	 */
	@Override
	protected BizDao<com.qtz.sm.wallet.vo.WtYccCsWithdrawals, java.lang.Long> getDao() {
		return dao;
	}
	...
	public void saveApplyWithdrawals(WtYccCsWithdrawals vo) throws ServiceException {
		...
		try {
			...
			for (WtWallet w : walletList) {	
				if (w.getPayerType() == CompanyType.SuperMarket.value()) {
	...
	public void saveAccepWithdrawals(WtYccCsWithdrawals vo) throws ServiceException {
		// TODO Auto-generated method stub
		try {
			WtYccCsWithdrawals withdrawals = dao.findVo(vo.getDmId(), null);
			if (null == withdrawals) {
			...
			//获取收款人已付钱包
			WtWallet wPaid=wtWalletService.getPaidByTissue(wWithdrawals.getPayerId(), CompanyType.SuperMarket.value(), CompanyType.CloudStorage.value(),WalletItemEnum.PAID.getValue());
			//获取收款人未付钱包
			WtWallet uwPaid=wtWalletService.getPaidByTissue(wWithdrawals.getPayerId(), CompanyType.SuperMarket.value(), CompanyType.CloudStorage.value(),WalletItemEnum.UPPAID.getValue());
	 ...
	 * @throws DaoException 
	 */
	public void addWtWithdrawalsOperation(WtYccCsWithdrawals vo, String createContent) throws DaoException {
